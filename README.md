...
+ *Variável*: endereço de memória que recebe informação
  + Variável pode receber um dado como uma palavra, um valor lógico, um número.
  + Variável pode ter diversas funções por exemplo: contador de frequências, acumulador de valor, registrador
...
[Dicionários](conteudo/basico/dicionarios.md)

## Referências
+ PYTHON SOFTWARE FOUNDATION. Python 3 Documentation. Disponível em: https://docs.python.org/3/. Acesso em: 21 maio 2026.
+ DOWNEY, Allen B. **Pense em Python: pense como um cientista da computação.** Tradução de Sheila Gomes. São Paulo: Novatec Editora, 2016. 312 p. ISBN 978-85-7522-508-0
